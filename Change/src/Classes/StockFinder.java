...
public class StockFinder
{
     ...
     * 
     * @param stockShortNames ArrayList<String> of stock names. These must be the 
     * short names used by NASDAQ (like GOOG for google.com).
     ...
     */
    public static ArrayList<Double> getStockData(List<String> stockShortNames)
    {       
